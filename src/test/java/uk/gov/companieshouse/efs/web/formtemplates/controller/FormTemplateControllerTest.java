...
class FormTemplateControllerTest extends BaseControllerImplTest {
    ...
    public static final FormTemplateApi FORM_TEMPLATE_1 =
        new FormTemplateApi("CC01", "Test01", "CAT1_SUB_LEVEL1", "100", true, true, null, false,
            null);
    public static final FormTemplateApi FORM_TEMPLATE_2 =
        new FormTemplateApi("CC02", "Test02", "CAT1_SUB_LEVEL1", "100", true, true, null, false,
            null);
    public static final FormTemplateApi FORM_TEMPLATE_3 =
        new FormTemplateApi("CC03", "Test03", "CAT1_SUB_LEVEL1", "100", true, true, null, false,
            null);
    public static final FormTemplateApi FORM_TEMPLATE_4 =
        new FormTemplateApi("RESOLUTIONS_CC", "Res01", "CAT1_SUB_LEVEL1", "100", true, true,
            "RESOLUTIONS", false, null);
